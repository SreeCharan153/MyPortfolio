  ...
  const projects = [
    {
      ...
      description:
        "Backend for a motorcycle ride-sharing platform using FastAPI. Includes JWT auth, OTP login, ride booking & cancellation, live GPS tracking via WebSockets, user wallet, and FairSplit — a mileage-based fare calculation engine.",
      image:
    ...
    },
    {
      ...
      description:
        "Flutter client for PillionPal communicating with secured FastAPI endpoints for real-time ride bookings, cancellations, wallet history, and live location streaming. Integrates MapBox for route visualization and WebSockets for driver-rider updates.",
      image:
      ...
      links: { github: "https://github.com/SreeCharan153/PillionPal" },
    },
    {
      title: "File Organizer Pro – Desktop Automation Tool",
      description:
        "Python automation tool that monitors folders in real-time and auto-sorts files based on rules, file type, and patterns. Includes duplicate detection, rollback logs, and SQLite persistence.",
    ...
    },
    {
      ...
      description:
        "Full banking stack with FastAPI backend and Next.js client. Supports account creation, hashed PIN auth, deposits, withdrawals, transfers, and logs.",
      image:
    ...
    },
    {
      ...
      description:
        "Event website with speaker profiles, schedules, and auth. Used Firebase CMS for organizers to manage content without code.",
      image:
